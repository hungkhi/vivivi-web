  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--bg)]">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-[var(--accent-pink)]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-[var(--accent-gold)]/5 rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-sm text-[var(--text-secondary)]">
            ...
            <Link href="/login" className="text-[var(--accent-pink)] hover:underline">
              Sign In
            </Link>
          </p>
          <p>
